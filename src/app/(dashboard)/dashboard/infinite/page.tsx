...
export default function InfinitePage() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-12 pb-20">
      ...
      {/* Locked Section */}
      <div className="relative group overflow-hidden rounded-[32px] bg-gradient-to-br from-indigo-900 to-purple-900 p-8 md:p-12 text-center text-white">
        ...
        <div className="relative z-10 space-y-4 max-w-xl mx-auto">
          <div className="w-14 h-14 rounded-full bg-white/10 backdrop-blur-xl flex items-center justify-center mx-auto border border-white/20">
            <Lock className="text-white" size={24} />
          </div>
          <h2 className="text-3xl font-black tracking-tight">Unlimited Scaling</h2>
          <p className="text-indigo-200 text-sm font-medium leading-relaxed">
            The Infinite plan removes all daily limits. Generate hundreds of pages, domains, and campaigns without ever hitting a wall.
          </p>
          <div className="pt-2">
            <Link
              href="/dashboard/settings"
              className="inline-flex items-center gap-2 px-8 py-3 rounded-xl bg-white hover:bg-indigo-50 text-indigo-900 font-black text-base transition-all hover:scale-105 shadow-xl"
            >
              Go Infinite
              <Infinity size={20} />
            </Link>
